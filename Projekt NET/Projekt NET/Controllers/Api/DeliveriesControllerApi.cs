...
namespace Projekt_NET.Controllers.Api
{
    ...
    [ApiController]
    public class DeliveriesControllerApi : ControllerBase
    {
        private readonly DroneDbContext _context;

        public DeliveriesControllerApi(DroneDbContext context)
        {
            _context = context;
        }

        // GET: api/DeliveriesControllerApi
        [HttpGet]
        ...
        // GET: api/DeliveriesControllerApi/5
        [HttpGet("{id}")]
        ...
        // PUT: api/DeliveriesControllerApi/5
        ...
        // POST: api/DeliveriesControllerApi
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/DeliveriesControllerApi/5
        [HttpDelete("{id}")]
